...
@WebServlet(name = "AdminUpdateImage", urlPatterns = { "/adminUpdateImage" })
public class AdminUpdateImageServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String uploadFilePath = getServletContext().getRealPath("/") + "Image" + "\\" + "title";
		...
		String afterPath = "/Image/title/" + afterFileName;

		String beforeFileName = multi.getParameter(value); // 전 사진 경로

		int result = new AdminService().updateImage(afterPath, beforeFileName);
